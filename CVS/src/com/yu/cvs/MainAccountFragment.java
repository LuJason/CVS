...
public class MainAccountFragment extends Fragment implements OnClickListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		v.findViewById(R.id.AccountChangePwd).setOnClickListener(this);
		v.findViewById(R.id.AccountBindPhone).setOnClickListener(this);
	...
	public void onClick(View v) {
		...
		case R.id.AccountAddress:
			...
			addParams.putInt(CAddressActivity.FRAGMENTMARK, CAddressActivity.FRAGMENT_LIST);
			addressIntent.putExtras(addParams);
			startActivity(addressIntent);
			break;
		case R.id.AccountChangePwd:
			Intent modifyPwdIntent = new Intent(getActivity(), AccountActivity.class);
			Bundle params = new Bundle();
			params.putInt(AccountActivity.KeyFragmentMark, AccountActivity.FragmentModifyPwd);
			modifyPwdIntent.putExtras(params);
			startActivity(modifyPwdIntent);
			break;
		case R.id.AccountBindPhone:
