...
//		LayoutParams viewLayoutParams = new LayoutParams(60, 45);
		...
		if(Build.VERSION.SDK_INT >= 16 ){
			mainLinearLayout.setBackground(context.getResources().getDrawable(R.drawable.base_button_bg));
		}else{
			mainLinearLayout.setBackgroundDrawable(context.getResources().getDrawable(R.drawable.base_button_bg));
		}
	}
